...
@section('content')
   ...
   <section class="content">
            <div class="row">
                ...
                <!-- general form elements -->
                    <div class="box box-primary clearfix">
                            <!-- form start -->
    	{!! Form::Open(['action'=>['UserController@update',$abc->id],'method'=>'POST']) !!}
    	@csrf
         <div class="box-body">
        <div class="form-group col-md-6">
            ...
            {{ Form::text('name',$abc->name,['class'=>'form-control'])}}
        ...
        <div class="form-group col-md-6">
            ...
            {{ Form::text('email',$abc->email,['class'=>'form-control'])}}
        ...
        <div class="form-group col-md-6">
            ...
            {{ Form::text('customer_name',$xyz->customer_name,['class'=>'form-control'])}}
